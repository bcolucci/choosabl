    ...
    return (
      <Fragment>
        <Grid container>
          <Grid item xs={12} sm={8} className={classes.spaced}>
            ...
            <Typography
              ...
              gutterBottom
            >
              Au travers de votre photo la perception qu'ont les autres
              influence le recrutement, les rendez-vous galants, etc.
            </Typography>
          </Grid>
        </Grid>
        <Grid container>
          ...
          <Grid item xs={6} sm={3}>
            ...
            >
              Elle compte pour beaucoup, pourtant vous ne faites pas le bon
              choix
            </Typography>
          </Grid>
        </Grid>
        ...
        <Grid container>
          <Grid item xs={12} sm={8} className={classes.spaced}>
            <Typography variant='subtitle1' style={pClass} gutterBottom>
              Soumettez au vote 2 photos et les autres vous diront celle qui
              vous gratifie le mieux.
            </Typography>
            <Typography variant='subtitle1' style={pClass} gutterBottom>
